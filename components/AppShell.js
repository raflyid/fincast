      ...
      `}</style>
            ...
            <div
                style={{
                    ...
                    /* Push content down by status bar height */
                    paddingTop: "env(safe-area-inset-top, 0px)",
                }}
            >
                <div
                ...
                >
                    ...
                    >
                        {user && (
                            ...
                            >
                                Hi,{" "}
                                <b style={{ color: T.text }}>{user.username}</b>
                            </span>
                        )}
                        <button
                            onClick={toggle}
            ...
            <div
                style={{ height: "calc(54px + env(safe-area-inset-top, 0px))" }}
            />
            ...
            {/* MOBILE BOTTOM NAV — fixed, covers home indicator area */}
            <nav
