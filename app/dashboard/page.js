  ...
  return (
    <AppShell onAddClick={() => setShowAdd(true)}>
      <div className="fade-up">
        ...
        >
          {[
            { label: "TOTAL SALDO", value: balance, color: T.accent },
        ...
        <div className="stat-grid-mobile" style={{ gap: 10, marginBottom: 14 }}>
            ...
            <ResponsiveContainer width="100%" height={200}>
              ...
              >
                ...
                <XAxis
                  ...
                  tickLine={false}
                  interval={
                    dailyData.length > 20 ? 2 : dailyData.length > 10 ? 1 : 0
                  }
                />
                <YAxis
                  tick={{
                ...
                />
                <Tooltip
                  content={<ChartTooltip T={T} labelPrefix="Tgl " />}
          ...
          <div style={card}>
            ...
            <ResponsiveContainer width="100%" height={210}>
              ...
              >
                  ...
                  content={({ active, payload, label }) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {payload.map((p, i) => {
                          // Use the bar's actual color
                          const BUDGET_BAR_COLOR = "#BEBAB5";
                          const barColor =
                            p.name === "Terpakai"
                              ? (CAT_COLORS[label] ?? T.accent)
                              : BUDGET_BAR_COLOR;
                          return (
                            <div
                              key={i}
                ...
                >
                  {catBarData.map((d, i) => (
                    <Cell key={i} fill={CAT_COLORS[d.name]} fillOpacity={0.9} />
                  ))}
                </Bar>
                <Bar
                  dataKey="budget"
                  ...
                  <PieChart>
                    ...
                    <Tooltip
                      content={({ active, payload }) => (
                        <PieTooltip active={active} payload={payload} T={T} />
                      )}
                    />
                  </PieChart>
                </ResponsiveContainer>
            ...
            transactions.slice(0, 5).map((t, i) => (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div
                    style={{ fontSize: 12, color: T.textMuted, marginTop: 1 }}
                  >
